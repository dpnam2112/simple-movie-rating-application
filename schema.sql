...
CREATE TABLE streaming_platform_film (
	platform_id INT,
    film_id INT,
...
CREATE TABLE user_rates_episode (
    ...
    FOREIGN KEY (film_id) REFERENCES tv_series(id),
